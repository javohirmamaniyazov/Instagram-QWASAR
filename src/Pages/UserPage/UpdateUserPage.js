...
import { updateAvatarUser } from "../../firebase/firebaseServise";
import ReactLoading from 'react-loading';
import useUser from "../../Listeners/UserListener";
import { updateUser } from '../../firebase/firebaseServise';
import EditModalProfile from "../../components/UpdateUser/UpdateModalProfile";
...
const EditUserPage = () => {
    ...
    const updateProfile = async () => {
        ...
        await updateUser(email, username, currentUser.docId);
        setLoading(false);
