...
import SmileSvg from "./EmojiSmile";
import { EMOJISCHAR } from "../../Helpers/Emojis";
import "./style.css";
import { storage } from '../../firebase/firebase';
import { v4 as uuidv4 } from 'uuid';
import useUser from '../../Listeners/UserListener';
import { addPostToFirestore } from '../../firebase/firebaseServise';
import ReactLoading from 'react-loading';

const PostConfirmation = ({ image, back }) => {
    const { user: { docId, username, userId, following } } = useUser();
                    ...
                    <div className="relative">
                        ...
                        <div className='flex'>
                            <textarea
                                ...
                                className="caption-textarea h-15 w-full mt-4 text-black"
