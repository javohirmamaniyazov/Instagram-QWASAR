...
// import SmileSvg from '../NewPost/EmojiSmile';
...
const AddComment = ({ docId, comments, setComments, commentInput }) => {
    ...
    return (
        <div className="">
            ...
            >
                <div
                    className="flex items-center ml-3 mr-2 cursor-pointer"
                ...
                <input
                    ...
                    autoComplete="off"
                    className="bg-gray-200 text-gray-900 text-sm w-full mr-3 py-5 px-4 rounded-lg"
                    type="text"
                    name="AddComment"
